...
import { UserReportListProps } from '../../types/props-types';
...
class UserReportsList extends React.PureComponent<UserReportListProps, any>{
    state = {
        assignVisible: false,
        reportId: null
    };

    constructor(props: UserReportListProps) {
        super(props);
        const userId = this.props.match.params.id;
        console.log(userId);
        this.props.getReportByUserId(userId);
    ...
    render() {
        return (
            <div>
                <Divider><FormattedMessage id="admin.accounts.reports" defaultMessage="Error!" /></Divider>
                <List
...
const UserReportsContainer = connect(mapStateToProps, mapDispatchToProps)(UserReportsList as any);
