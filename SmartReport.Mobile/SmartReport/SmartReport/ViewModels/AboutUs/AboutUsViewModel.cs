...
using SmartReport.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace SmartReport.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:SmartReport.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
