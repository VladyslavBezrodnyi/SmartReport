...
namespace SmartReport.ViewModels.Transaction
{
    /// <summary>
    ...
    public class PaymentViewModel
    {
        ...
        public Command BackCommand
        {
            get
            {
                return new Command(async () => await StaticHandler.Navigation.PushModalAsync(new NavigationPage(new SelectableNamePage())));
            }
        }
